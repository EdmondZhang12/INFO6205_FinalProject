...
public class GameInterfacePvP extends JFrame {
     ...
     */
    private GameInterfacePvP(Mode mode) {
        this.mode = mode;
        board = new Board();
        loadCells();
        panel = createPanel();
    ...
    public static void main() {
        ...
        if (mode.equals("pvp")) {
            ...
            SwingUtilities.invokeLater(() -> new GameInterfacePvP(Mode.PvP));
        } else if (mode.equals("pve")) {
            System.out.println("Game Mode: Player vs. AI");
            SwingUtilities.invokeLater(() -> new GameInterfacePvP(Mode.PvE));
        } else {
            //Todo: is it necessary?
            System.out.println("Game Mode: AI vs. AI");
            SwingUtilities.invokeLater(() -> new GameInterfacePvP(Mode.NonPlayer));
        }
    }
